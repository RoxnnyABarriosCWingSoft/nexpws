...
import SymmetricDecryptException from './Shared/Exceptions/SymmetricDecryptException';
...
const exceptions = {
    ...
    [SymmetricDecryptException.name]: StatusCode.HTTP_BAD_REQUEST,
    [RoleWithoutAdministrativeAccessException.name]: StatusCode.HTTP_FORBIDDEN
};
