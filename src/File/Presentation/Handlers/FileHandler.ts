...
FileHandler.get('/', AuthorizeMiddleware('some', FilePermissions.I.LIST), async(ctx: Koa.ParameterizedContext & any) =>
{
...
FileHandler.get('/objects', AuthorizeMiddleware('some', FilePermissions.I.LIST), async(ctx: Koa.ParameterizedContext & any) =>
{
...
FileHandler.get('/:id/metadata', AuthorizeMiddleware('some', FilePermissions.I.SHOW_METADATA), async(ctx: Koa.ParameterizedContext & any) =>
{
...
FileHandler.post('/base64', AuthorizeMiddleware('some', FilePermissions.I.UPLOAD), async(ctx: Koa.ParameterizedContext & any) =>
{
    const body = {
...
FileHandler.post('/', <any>FileReqMulter.single('file'), AuthorizeMiddleware('some', FilePermissions.I.UPLOAD), async(ctx: Koa.ParameterizedContext & any) =>
{
    const body = {
...
FileHandler.post('/presigned-get-object', AuthorizeMiddleware('some', FilePermissions.I.DOWNLOAD), async(ctx: Koa.ParameterizedContext) =>
{
    const body = {
        data: ctx.request.body,
        query: ctx.query
...
FileHandler.get('/:id', AuthorizeMiddleware('some', FilePermissions.I.DOWNLOAD), async(ctx: Koa.ParameterizedContext) =>
{
    const _request = new IdRequest({ id: ctx.params.id });
...
FileHandler.delete('/:id', AuthorizeMiddleware('some', FilePermissions.I.DELETE), async(ctx: Koa.ParameterizedContext) =>
{
    const _request = new IdRequest({ id: ctx.params.id });
...
FileHandler.put('/:id/base64', AuthorizeMiddleware('some', FilePermissions.I.UPDATE), async(ctx: Koa.ParameterizedContext) =>
{
    const body = {
        data: ctx.request.body,
        query: ctx.query,
...
FileHandler.put('/:id', <any>FileReqMulter.single('file'), AuthorizeMiddleware('some', FilePermissions.I.UPDATE), async(ctx: Koa.ParameterizedContext) =>
{
    const body = {
        file: ctx.request.file,
        query: ctx.params,
