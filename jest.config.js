...
module.exports = {
  ...
  coveragePathIgnorePatterns: [
    ...
    "<rootDir>/src/File/Infrastructure/Repositories/FileRepository.ts",
    "<rootDir>/src/User/Infrastructure/Repositories/UserRepository.ts",
    "<rootDir>/src/Role/Infrastructure/Repositories/RoleRepository.ts",
    "<rootDir>/src/Log/Infrastructure/Repositories/LogRepository.ts",
